...
class LogAspect { // @AspectJ 지원 AOP, 횡단 관심 - 공통 기능 (로그, .... ),
    ...
    @Pointcut("execution(* idusw.springboot.egymall.serivce.*ServiceImpl.*(..))")
    public void getLogging() {} //PointCut Signature (프린트컷 서명)
    ...
    public void loggerAfterReturning(JoinPoint joinPoint) { //PointCut Signature (프린트컷 서명)
